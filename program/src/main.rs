...
pub fn main() {
    ...
    // Gather the headers for computing the bridge commitment across the block range.
    // Target header included here but excluded when computing the bridge commitment.
